...
public class ProjectAttribute  implements java.io.Serializable {
    ...
    private br.lry.qa.alm.webservices.scm.tests.AttributeOption[] options;
    ...
    public ProjectAttribute(
           ...
           br.lry.qa.alm.webservices.scm.tests.AttributeOption[] options,
           int precision,
     ...
     * @return options
     */
    public br.lry.qa.alm.webservices.scm.tests.AttributeOption[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(br.lry.qa.alm.webservices.scm.tests.AttributeOption[] options) {
        this.options = options;
    }

    public br.lry.qa.alm.webservices.scm.tests.AttributeOption getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, br.lry.qa.alm.webservices.scm.tests.AttributeOption _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/tests", "projectAttribute"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/tests", "attributeOption"));
        elemField.setMinOccurs(0);
