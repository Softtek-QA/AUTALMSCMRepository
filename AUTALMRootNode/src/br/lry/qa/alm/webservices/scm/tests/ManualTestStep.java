...
public class ManualTestStep  implements java.io.Serializable {
    ...
    private br.lry.qa.alm.webservices.scm.tests.CustomStepProperty[] properties;
    ...
    public ManualTestStep(
           ...
           br.lry.qa.alm.webservices.scm.tests.CustomStepProperty[] properties,
           int stepPos) {
     ...
     * @return properties
     */
    public br.lry.qa.alm.webservices.scm.tests.CustomStepProperty[] getProperties() {
        return properties;
    }
     ...
     * @param properties
     */
    public void setProperties(br.lry.qa.alm.webservices.scm.tests.CustomStepProperty[] properties) {
        this.properties = properties;
    }

    public br.lry.qa.alm.webservices.scm.tests.CustomStepProperty getProperties(int i) {
        return this.properties[i];
    }

    public void setProperties(int i, br.lry.qa.alm.webservices.scm.tests.CustomStepProperty _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/tests", "manualTestStep"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/tests", "customStepProperty"));
        elemField.setMinOccurs(0);
