...
public class ExecutionNode  implements java.io.Serializable {
    ...
    private br.lry.qa.alm.webservices.scm.executionplanning.PropertyValue[] propertyValues;
    ...
    public ExecutionNode(
           int id,
           int kind,
           br.lry.qa.alm.webservices.scm.executionplanning.PropertyValue[] propertyValues) {
           this.id = id;
           this.kind = kind;
     ...
     */
    public br.lry.qa.alm.webservices.scm.executionplanning.PropertyValue[] getPropertyValues() {
        return propertyValues;
    }
     ...
     */
    public void setPropertyValues(br.lry.qa.alm.webservices.scm.executionplanning.PropertyValue[] propertyValues) {
        this.propertyValues = propertyValues;
    }

    public br.lry.qa.alm.webservices.scm.executionplanning.PropertyValue getPropertyValues(int i) {
        return this.propertyValues[i];
    }

    public void setPropertyValues(int i, br.lry.qa.alm.webservices.scm.executionplanning.PropertyValue _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/executionplanning", "executionNode"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/executionplanning", "propertyValue"));
