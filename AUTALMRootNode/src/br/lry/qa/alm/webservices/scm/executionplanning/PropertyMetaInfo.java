...
public class PropertyMetaInfo  implements java.io.Serializable {
    ...
    public java.lang.String getAllListValues(int i) {
        return this.allListValues[i];
    }

    public void setAllListValues(int i, java.lang.String _value) {
        this.allListValues[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/executionplanning", "propertyMetaInfo"));
