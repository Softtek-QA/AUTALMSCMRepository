...
public class PropertyValue  implements java.io.Serializable {
    private br.lry.qa.alm.webservices.scm.tests.PropertyValue[] children;
    ...
    public PropertyValue(
           br.lry.qa.alm.webservices.scm.tests.PropertyValue[] children,
           int modifyCount,
     ...
     * @return children
     */
    public br.lry.qa.alm.webservices.scm.tests.PropertyValue[] getChildren() {
        return children;
    }
     ...
     * @param children
     */
    public void setChildren(br.lry.qa.alm.webservices.scm.tests.PropertyValue[] children) {
        this.children = children;
    }

    public br.lry.qa.alm.webservices.scm.tests.PropertyValue getChildren(int i) {
        return this.children[i];
    }

    public void setChildren(int i, br.lry.qa.alm.webservices.scm.tests.PropertyValue _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/tests", "propertyValue"));
