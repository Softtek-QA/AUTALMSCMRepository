...
public class ExecutionResult  implements java.io.Serializable {
    ...
    private br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult cleanupTestDef;
    ...
    private br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult setupTestDef;

    private br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult[] testDefResult;
    ...
    public ExecutionResult(
           ...
           br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult cleanupTestDef,
           int execDefId,
           java.lang.String execDefName,
           java.lang.String execServerName,
           java.lang.String[] keywords,
           java.lang.String manualTester,
           br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult setupTestDef,
           br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult[] testDefResult) {
           this.build = build;
     ...
     */
    public br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult getCleanupTestDef() {
        return cleanupTestDef;
    }
     ...
     */
    public void setCleanupTestDef(br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult cleanupTestDef) {
        this.cleanupTestDef = cleanupTestDef;
    }
     ...
     * @return setupTestDef
     */
    public br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult getSetupTestDef() {
        return setupTestDef;
    }
     ...
     * @param setupTestDef
     */
    public void setSetupTestDef(br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult setupTestDef) {
        this.setupTestDef = setupTestDef;
    }
     ...
     */
    public br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult[] getTestDefResult() {
        return testDefResult;
    }
     ...
     * @param testDefResult
     */
    public void setTestDefResult(br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult[] testDefResult) {
        this.testDefResult = testDefResult;
    }

    public br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult getTestDefResult(int i) {
        return this.testDefResult[i];
    }

    public void setTestDefResult(int i, br.lry.qa.alm.webservices.scm.executionplanning.TestDefinitionResult _value) {
        this.testDefResult[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/executionplanning", "executionResult"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.microfocus.com/silkcentral/webservices/executionplanning", "testDefinitionResult"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
